...
class Circle extends Shape {
  ...
  render() {
    return `<circle cx="${this.radius}" cy="${this.radius}" r="${this.radius}" fill="${this.fill}" stroke="black" stroke-width="2" />`;
  }
}

// Triangle class
class Triangle extends Shape {
  constructor(sideLength, fill) {
    super();
  ...
  render() {
    ...
    return `<polygon points="0,${height} ${this.sideLength},${height} ${
      this.sideLength / 2
    },0" fill="${this.fill}" stroke="black" stroke-width="2" />`;
  }
}
...
class Square extends Shape {
  ...
  render() {
    return `<rect width="${this.sideLength}" height="${this.sideLength}" fill="${this.fill}" stroke="black" stroke-width="2" />`;
  }
}
